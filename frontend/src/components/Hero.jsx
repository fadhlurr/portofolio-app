export default function Hero() {
  ...
  const profileUrl =
    "https://ofaakrpogajdxcztswap.supabase.co/storage/v1/object/public/portfolio-assets/WhatsApp%20Image%202026-08-13%20at%2003.55.25.jpeg";
    ...
    <header className="hero">
      <div className="wrap hero-grid">
        <div>
          ...
          <p className="desc">
            I build digital experiences that turn everyday data into something
          ...
          <div className="socials">
            ...
            <a
              className="social-btn"
              href="mailto:hello@bbbyfadhlur.com"
              aria-label="Email"
            >
              <svg
                viewBox="0 0 24 24"
                ...
                strokeWidth="1.8"
              >
                <path d="M3 6l9 7 9-7M3 6h18v12H3V6z" />
              </svg>
            </a>
          </div>
        </div>
